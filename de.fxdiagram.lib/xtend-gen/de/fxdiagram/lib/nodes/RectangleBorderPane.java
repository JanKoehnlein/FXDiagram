...
public class RectangleBorderPane extends StackPane implements SvgExportable {
  ...
  protected void updateStyle() {
    ...
    CharSequence _css = JavaToCss.toCss(this.getBorderPaint());
    ...
    CharSequence _css_1 = JavaToCss.toCss(this.getBackgroundPaint());
    ...
    CharSequence _css_2 = JavaToCss.toCss(this.getBorderInsets());
  ...
  public CharSequence toSvgElement(@Extension final SvgExporter exporter) {
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    CharSequence _svgString = exporter.toSvgString(this.getLocalToSceneTransform());
    ...
    CharSequence _svgString_1 = exporter.toSvgString(this.getBackgroundPaint());
    _builder_1.append(_svgString_1, "\t");
    _builder_1.append("\"");
    _builder_1.newLineIfNotEmpty();
    _builder_1.append("\t");
    _builder_1.append("stroke=\"");
    CharSequence _svgString_2 = exporter.toSvgString(this.getBorderPaint());
    ...
    _builder_1.newLineIfNotEmpty();
    _builder_1.append("\t");
    CharSequence _svgAttribute = exporter.toSvgAttribute(Double.valueOf(this.getOpacity()), "opacity", Double.valueOf(1.0));
