  ...
  protected Group createGroup() {
    ...
    final Procedure1<Group> _function = new Procedure1<Group>() {
      public void apply(final Group it) {
        ...
        final Procedure1<SVGPath> _function_2 = new Procedure1<SVGPath>() {
          public void apply(final SVGPath it) {
            ...
            LinearGradient _linearGradient = new LinearGradient(
              ...
              false, 
              CycleMethod.NO_CYCLE, _stop, _stop_1, _stop_2);
            it.setFill(_linearGradient);
          }
        };
        SVGPath _doubleArrow_2 = ObjectExtensions.<SVGPath>operator_doubleArrow(_sVGPath_2, _function_2);
        _children_2.add(_doubleArrow_2);
        ObservableList<Node> _children_3 = it.getChildren();
        SVGPath _sVGPath_3 = new SVGPath();
        final Procedure1<SVGPath> _function_3 = new Procedure1<SVGPath>() {
          public void apply(final SVGPath it) {
            it.setContent("m 13.842,83.873 c 0,2.83 9.374,10.294 11.391,12.021 10.726,9.183 24.172,14.539 38.305,15.052 14.944,0.539 29.649,-3.849 42.247,-11.796 4.328,-2.729 8.4,-5.854 12.21,-9.27 0.515,-0.461 3.912,-4.399 4.675,-4.179 0.612,0.177 -12.533,14.285 -13.504,15.072 -12.204,9.93 -27.383,15.891 -43.197,15.891 -14.793,0 -28.845,-5.701 -39.604,-15.808 C 22.872,97.576 13.842,89.375 13.842,83.873");
            Color _color = Color.color(
              1.0, 
              0.6392156862745098, 
              0.6392156862745098);
        ...
        SVGPath _doubleArrow_3 = ObjectExtensions.<SVGPath>operator_doubleArrow(_sVGPath_3, _function_3);
        _children_3.add(_doubleArrow_3);
        ObservableList<Node> _children_4 = it.getChildren();
        SVGPath _sVGPath_4 = new SVGPath();
        final Procedure1<SVGPath> _function_4 = new Procedure1<SVGPath>() {
          public void apply(final SVGPath it) {
            it.setContent("m 34.692,64.009 c 0.196,2.275 6.695,7.454 8.483,8.884 8.192,6.55 18.279,8.777 28.609,7.948 9.901,-0.796 26.275,-5.766 29.778,-16.91 -3.592,11.425 -14.2,19.624 -25.682,21.923 -15.078,3.015 -39.553,-3 -41.188,-21.845");
            Color _color = Color.color(
              0.6980392156862745, 
              0.050980392156862744, 
              0.050980392156862744);
        ...
        SVGPath _doubleArrow_4 = ObjectExtensions.<SVGPath>operator_doubleArrow(_sVGPath_4, _function_4);
        ...
        final Procedure1<SVGPath> _function_5 = new Procedure1<SVGPath>() {
          public void apply(final SVGPath it) {
            it.setContent("m 102.4,8.009 c 2.229,-4.608 16.587,7.405 16.066,9.742 0.063,-0.283 -4.482,-2.673 -5.126,-2.601 -1.48,0.167 6.305,14.689 7.322,14.479 -3.646,0.757 -11.687,-5.402 -13.663,-8.28 -1.714,-2.495 -6.164,-10.088 -4.599,-13.34");
            it.setFill(Color.WHITE);
          }
        };
        SVGPath _doubleArrow_5 = ObjectExtensions.<SVGPath>operator_doubleArrow(_sVGPath_5, _function_5);
        ...
        final Procedure1<SVGPath> _function_6 = new Procedure1<SVGPath>() {
          public void apply(final SVGPath it) {
            it.setContent("M 19.027,34.021 C 17.605,32.25 15.848,30.488 13.76,29.528 9.386,27.516 10.079,32.158 7.441,32.896 9.124,32.425 12.339,5.814 19.403,13.057 c 4.221,4.326 13.22,27.401 -0.376,20.964");
            it.setFill(Color.WHITE);
          }
        };
        SVGPath _doubleArrow_6 = ObjectExtensions.<SVGPath>operator_doubleArrow(_sVGPath_6, _function_6);
        ...
        Affine _doubleArrow_7 = ObjectExtensions.<Affine>operator_doubleArrow(_affine, _function_7);
