...
class TransformExtensionsTest {
	...
	def test0() {
		val matrices = newArrayList(
			...
			new Rotate(90),
			new Rotate(5, 6, 7),
			new Rotate(8, 9, 10, 11),
			new Rotate(12, 13, 14, 15, new Point3D(16, 17, 18)),
			new Rotate(19, new Point3D(20, 21, 22)),
			new Scale(23, 24),
			new Scale(25, 26, 27),
			new Scale(28, 29, 30, 31),
			new Scale(32, 33, 34, 35, 36, 37),
			new Shear(38, 39),
			new Shear(40, 41)
		)
		val operations = <(Affine)=>void>newArrayList(
			...
			[rotate(5, 6, 7)],
			[rotate(8, 9, 10, 11)],
			[rotate(12, 13, 14, 15, new Point3D(16, 17, 18))],
			[rotate(19, new Point3D(20, 21, 22))],
			[scale(23, 24)],
			[scale(25, 26, 27)],
			[scale(28, 29, 30, 31)],
			[scale(32, 33, 34, 35, 36, 37)],
			[shear(38, 39)],
			[shear(40, 41)]
		)
