...
class TransformExtensions {
	...
	def static Transform operator_multiply(Transform l, Transform r) {
		Transform::affine(
			...
			l.mxx * r.tx + l.mxy * r.ty + l.mxz * r.tz + l.tx,

			l.myx * r.mxx + l.myy * r.myx + l.myz * r.mzx,
			l.myx * r.mxy + l.myy * r.myy + l.myz * r.mzy,
			l.myx * r.mxz + l.myy * r.myz + l.myz * r.mzz,
			l.myx * r.tx + l.myy * r.ty + l.myz * r.tz + l.ty,

			l.mzx * r.mxx + l.mzy * r.myx + l.mzz * r.mzx,
			l.mzx * r.mxy + l.mzy * r.myy + l.mzz * r.mzy,
			l.mzx * r.mxz + l.mzy * r.myz + l.mzz * r.mzz,
			l.mzx * r.tx + l.mzy * r.ty + l.mzz * r.tz + l.tz)
	}
