...
public class PsiClassNode extends BaseFlipNode<PsiClass> {
  ...
  @Override
  public PsiDomainObjectDescriptor<PsiClass> getDomainObject() {
    return (PsiDomainObjectDescriptor<PsiClass>) super.getDomainObject();
  }
    ...
    Node _xblockexpression = null;
    {
      ...
      final Procedure1<VBox> _function_2 = (VBox it) -> {
        ...
        final Procedure1<Text> _function_3 = (Text it_1) -> {
          ...
          PsiDomainObjectDescriptor<PsiClass> _domainObject = this.getDomainObject();
          String _fqn = _domainObject.withDomainObject(psiClass -> psiClass.getQualifiedName());
          final int lastIndexOf = _fqn.lastIndexOf(".");
          String _xifexpression = null;
          if ((lastIndexOf != (-1))) {
            _xifexpression = _fqn.substring(0, lastIndexOf);
          } else {
      ...
      final Procedure1<VBox> _function_3 = (VBox c) -> {
        ...
        PsiDomainObjectDescriptor<PsiClass> _domainObject = this.getDomainObject();
        final Function1<PsiClass, Object> _function_4 = (PsiClass type) -> {
          Object _xblockexpression_1 = null;
          {
            Iterable<PsiField> _attributes = PsiJavaUtil.getAttributes(type);
            final Consumer<PsiField> _function_5 = (PsiField field) -> {
              ObservableList<Node> _children = c.getChildren();
              Text _text = new Text();
              final Procedure1<Text> _function_6 = (Text it) -> {
                it.setTextOrigin(VPos.TOP);
                StringConcatenation _builder = new StringConcatenation();
                String _simpleName = field.getName();
                _builder.append(_simpleName, "");
                _builder.append(": ");
                PsiType _type = field.getType();
                String _simpleName_1 = _type.getPresentableText();
      ...
      final Procedure1<VBox> _function_4 = (VBox c) -> {
        ...
        c.setPadding(_insets);
        PsiDomainObjectDescriptor<PsiClass> _domainObject = this.getDomainObject();
        final Function1<PsiClass, Object> _function_5 = (PsiClass type) -> {
          Object _xblockexpression_1 = null;
          {
            Iterable<PsiMethod> _methods = PsiJavaUtil.getOperations(type);
            final Consumer<PsiMethod> _function_6 = (PsiMethod operation) -> {
              ObservableList<Node> _children = c.getChildren();
              Text _text = new Text();
              final Procedure1<Text> _function_7 = (Text it) -> {
                it.setTextOrigin(VPos.TOP);
                StringConcatenation _builder = new StringConcatenation();
                String _simpleName = operation.getName();
                _builder.append(_simpleName, "");
                _builder.append("() : ");
                PsiType _returnType = operation.getReturnType();
                String _simpleName_1 = _returnType == null ? "void" : _returnType.getPresentableText();
                _builder.append(_simpleName_1, "");
                it.setText(_builder.toString());
              };
