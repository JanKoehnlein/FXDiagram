...
public class AddSuperTypeRapidButtonBehavior extends AbstractBehavior<JavaTypeNode> {
  private List<XRapidButton> buttons;
  
  private Map<Object,Class<? extends Object>> key2availableSuperType = new Function0<Map<Object,Class<? extends Object>>>() {
    public Map<Object,Class<? extends Object>> apply() {
      HashMap<Object,Class<? extends Object>> _newHashMap = CollectionLiterals.<Object, Class<? extends Object>>newHashMap();
      return _newHashMap;
    }
  }.apply();
  ...
  protected void doActivate() {
    ...
    final Procedure1<Class<? extends Object>> _function = new Procedure1<Class<? extends Object>>() {
      public void apply(final Class<? extends Object> it) {
        String _key = AddSuperTypeRapidButtonBehavior.this.getKey(it);
        AddSuperTypeRapidButtonBehavior.this.key2availableSuperType.put(_key, it);
      }
    };
    ...
    if (_not) {
      ...
      final ListChangeListener<XConnection> _function_2 = new ListChangeListener<XConnection>() {
        public void onChanged(final Change<? extends XConnection> change) {
            ...
            if (_wasAdded) {
              ...
              final Procedure1<XConnection> _function = new Procedure1<XConnection>() {
                public void apply(final XConnection it) {
                  ...
                  AddSuperTypeRapidButtonBehavior.this.key2availableSuperType.remove(_key);
                }
              };
          ...
          boolean _isEmpty = AddSuperTypeRapidButtonBehavior.this.key2availableSuperType.isEmpty();
          if (_isEmpty) {
  ...
  protected String getKey(final Class<? extends Object> superType) {
    JavaTypeNode _host = this.getHost();
    ...
    String _simpleName_1 = superType.getSimpleName();
  ...
  protected void createChooser(final XRapidButton button) {
    ...
    Collection<Class<? extends Object>> _values = this.key2availableSuperType.values();
    final Procedure1<Class<? extends Object>> _function = new Procedure1<Class<? extends Object>>() {
    ...
    IterableExtensions.<Class<? extends Object>>forEach(_values, _function);
    final ChooserConnectionProvider _function_1 = new ChooserConnectionProvider() {
      public XConnection getConnection(final XNode host, final XNode choice, final Object choiceInfo) {
        ...
        String _key = AddSuperTypeRapidButtonBehavior.this.getKey(_javaType);
