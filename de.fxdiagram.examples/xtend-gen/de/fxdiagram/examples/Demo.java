  ...
  public Scene createScene() {
    Scene _xblockexpression = null;
    {
      ...
      final Procedure1<XDiagram> _function_1 = (XDiagram it) -> {
        ...
        OpenableDiagramNode _doubleArrow_2 = ObjectExtensions.<OpenableDiagramNode>operator_doubleArrow(_openableDiagramNode, _function_3);
        _nodes_1.add(_doubleArrow_2);
      };
      ...
      Iterable<XNode> _tail = IterableExtensions.<XNode>tail(_nodes_1);
      final Iterable<XNode> allNodes = Iterables.<XNode>concat(_nodes, _tail);
      double _width = scene.getWidth();
      int _size = IterableExtensions.size(allNodes);
      int _plus = (_size + 2);
      final double deltaX = (_width / _plus);
      double _height = scene.getHeight();
      int _size_1 = IterableExtensions.size(allNodes);
      ...
      int _size_2 = IterableExtensions.size(allNodes);
      ...
      for (final Integer i : _doubleDotLessThan) {
        ...
        XNode _get = ((XNode[])Conversions.unwrapArray(allNodes, XNode.class))[((i).intValue() - 1)];
        int _size_3 = IterableExtensions.size(allNodes);
        int _modulo = ((i).intValue() % _size_3);
        XNode _get_1 = ((XNode[])Conversions.unwrapArray(allNodes, XNode.class))[_modulo];
