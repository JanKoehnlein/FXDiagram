        ...
        public void apply(final XDiagram it) {
          ...
          final Procedure1<MovieNode> _function_7 = new Procedure1<MovieNode>() {
            public void apply(final MovieNode it) {
              try {
                String _uRI = UriExtensions.toURI(Main.this, "media/ScreenFlow.mp4");
          ...
          BrowserNode _browserNode = new BrowserNode("My Blog");
          ...
          EClassNode _doubleArrow_9 = ObjectExtensions.<EClassNode>operator_doubleArrow(_eClassNode, _function_12);
          _nodes_9.add(_doubleArrow_9);
          ObservableList<XNode> _nodes_10 = it.getNodes();
          NeonSignNode _neonSignNode = new NeonSignNode();
          final Procedure1<NeonSignNode> _function_13 = new Procedure1<NeonSignNode>() {
          ...
          NeonSignNode _doubleArrow_10 = ObjectExtensions.<NeonSignNode>operator_doubleArrow(_neonSignNode, _function_13);
          ...
          final Procedure1<OpenableDiagramNode> _function_14 = new Procedure1<OpenableDiagramNode>() {
            public void apply(final OpenableDiagramNode it) {
          ...
          OpenableDiagramNode _doubleArrow_11 = ObjectExtensions.<OpenableDiagramNode>operator_doubleArrow(_openableDiagramNode_1, _function_14);
          _nodes_11.add(_doubleArrow_11);
          ObservableList<XNode> _nodes_12 = it.getNodes();
          LoginNode _loginNode = new LoginNode();
          final Procedure1<LoginNode> _function_15 = new Procedure1<LoginNode>() {
          ...
          LoginNode _doubleArrow_12 = ObjectExtensions.<LoginNode>operator_doubleArrow(_loginNode, _function_15);
          _nodes_12.add(_doubleArrow_12);
        }
      };
