    ...
    Scene _xblockexpression = null;
    {
      ...
      final Procedure1<XDiagram> _function = new Procedure1<XDiagram>() {
        public void apply(final XDiagram it) {
          ...
          final Procedure1<LoginNode> _function = new Procedure1<LoginNode>() {
          ...
          LoginNode _doubleArrow = ObjectExtensions.<LoginNode>operator_doubleArrow(_loginNode, _function);
