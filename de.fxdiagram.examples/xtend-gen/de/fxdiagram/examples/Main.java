...
public class Main extends Application {
  ...
  public Scene createScene() {
    Scene _xblockexpression = null;
    {
      ...
      Text _text = connectionLabel2.getText();
      _text.setText("cubic");
      ...
      Text _text_1 = connectionLabel3.getText();
      _text_1.setText("polyline");
      ...
      OpenableDiagramNode _doubleArrow = ObjectExtensions.<OpenableDiagramNode>operator_doubleArrow(_openableDiagramNode_1, _function_13);
