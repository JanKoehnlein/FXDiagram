    ...
    if (_not) {
      ...
      final ListChangeListener<XConnection> _function_1 = new ListChangeListener<XConnection>() {
        public void onChanged(final Change<? extends XConnection> change) {
            ...
            if (_wasAdded) {
              ...
              final Procedure1<XConnection> _function = new Procedure1<XConnection>() {
                public void apply(final XConnection it) {
                  ...
                  AddESuperTypeRapidButtonBehavior.this.availableReferences.remove(_key);
                }
              };
          ...
          boolean _isEmpty = AddESuperTypeRapidButtonBehavior.this.availableReferences.isEmpty();
          if (_isEmpty) {
