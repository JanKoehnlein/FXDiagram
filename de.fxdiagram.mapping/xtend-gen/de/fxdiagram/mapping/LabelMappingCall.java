...
public class LabelMappingCall<RESULT extends Object, ARG extends Object> extends AbstractLabelMappingCall<RESULT, ARG> {
  private final Function1<? super ARG, ? extends RESULT> selector;
  
  private final AbstractLabelMapping<RESULT> labelMapping;
  
  public LabelMappingCall(final Function1<? super ARG, ? extends RESULT> selector, final AbstractLabelMapping<RESULT> labelMapping) {
    super();
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    LabelMappingCall<?, ?> other = (LabelMappingCall<?, ?>) obj;
