...
public class TransformExtensionsTest {
  ...
  public void test0() {
    ...
    final Procedure1<Affine> _function = (Affine it) -> {
      TransformExtensions.translate(it, 1, 2);
    };
    final Procedure1<Affine> _function_1 = (Affine it) -> {
      TransformExtensions.translate(it, 1, 2, 3);
    };
    final Procedure1<Affine> _function_2 = (Affine it) -> {
      TransformExtensions.rotate(it, 90);
    };
    final Procedure1<Affine> _function_3 = (Affine it) -> {
      TransformExtensions.rotate(it, 5, 6, 7);
    };
    final Procedure1<Affine> _function_4 = (Affine it) -> {
      TransformExtensions.rotate(it, 8, 9, 10, 11);
    };
    final Procedure1<Affine> _function_5 = (Affine it) -> {
      Point3D _point3D_2 = new Point3D(16, 17, 18);
      TransformExtensions.rotate(it, 12, 13, 14, 15, _point3D_2);
    };
    final Procedure1<Affine> _function_6 = (Affine it) -> {
      Point3D _point3D_2 = new Point3D(20, 21, 22);
      TransformExtensions.rotate(it, 19, _point3D_2);
    };
    final Procedure1<Affine> _function_7 = (Affine it) -> {
      TransformExtensions.scale(it, 23, 24);
    };
    final Procedure1<Affine> _function_8 = (Affine it) -> {
      TransformExtensions.scale(it, 25, 26, 27);
    };
    final Procedure1<Affine> _function_9 = (Affine it) -> {
      TransformExtensions.scale(it, 28, 29, 30, 31);
    };
    final Procedure1<Affine> _function_10 = (Affine it) -> {
      TransformExtensions.scale(it, 32, 33, 34, 35, 36, 37);
    };
    final Procedure1<Affine> _function_11 = (Affine it) -> {
      TransformExtensions.shear(it, 38, 39);
    };
    final Procedure1<Affine> _function_12 = (Affine it) -> {
